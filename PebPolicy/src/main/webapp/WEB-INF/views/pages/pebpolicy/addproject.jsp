       ...
       <option id="${list.key}" value="${list.value.getName()}">${list.value.getName()}</option>   
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Add Project Details</h1>
						
					</div>
					<form:form method="post" modelAttribute="pebProjectBean">
									...
									<thead>
										...
										<tr>
											...
											<td><form:select path="localCurrencyCode"
												...
												</form:select> <form:errors path="localCurrencyCode" cssClass="text-danger" /></td>
